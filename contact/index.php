		...
		<div class="container-form">
			...
			<div>
				...
				<div style="text-align: center" >
					<input style="width:200px; height: 40px; background-color: black; color: white; font-size:18px" type="submit" value="Đăng ký" name="register" class="button-register" id="button-register">
				</div>
			</div>
		</form>
		</div>
